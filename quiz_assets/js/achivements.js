...
class AchievementSystem {
    constructor() {
        ...
        this.achievements = {
            ...
            '1minute': { 
                id: '1minute',
                name: 'Спринтер', 
                description: 'Пройдите викторину менее чем за 1 минуту',
                image: 'quiz_assets/img/1minute.png', 
                earned: false 
            },
            '30second': { 
                id: '30second',
    ...
    onQuizComplete(score, timeSeconds, totalQuestions, region) {
        ...
        if (timeSeconds < 30) {
            ...
            this.unlockAchievement('1minute');
        }

        // Достижения по лидерборду будут проверяться отдельно
